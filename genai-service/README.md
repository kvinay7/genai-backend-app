...
4. **Formatter Agent** → Structures final response with metadata (execution_id, latency_ms, etc.)

If any stage detects an error, flow short-circuits to the formatter agent with error details.
